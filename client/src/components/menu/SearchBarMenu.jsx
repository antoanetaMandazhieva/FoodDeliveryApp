...
const SearchBarMenu = () => {
    return (
        ...
        >
            ...
            <div className='grid-cols-subgrid col-span-3 flex justify-between items-center'>
                
                {/* Filter 1 */}
                
                <a href='#salads-section'>
                    <div className='flex flex-col justify-between items-center pt-2'>
                        <svg fill='#000000' version='1.1' id='Capa_1' 
                            xmlns='http://www.w3.org/2000/svg' 
                            xmlns:xlink='http://www.w3.org/1999/xlink' 
                            viewBox='0 0 190.399 190.4'
                            xml:space='preserve'
                            className='bg-peach-100 rounded-full max-sm:size-7 sm:size-8 md:size-10 lg:size-12 xl:size-14'
                        >
                            <g>
                ...
                <a href='#desserts-section'>
                    <div className='flex flex-col justify-between items-center pt-2'>
                        <svg viewBox='0 0 24 24' fill='none' 
                            ...
                            className='bg-peach-100 rounded-full max-sm:size-7 sm:size-8 md:size-10 lg:size-12 xl:size-14'
                        >
                            <path d='M3 15.9248C3 13.5162 3.51623 13 5.9248 13H18.0752C20.4838 13 21 13.5162 21 15.9248V18.0752C21 20.4838 20.4838 21 18.0752 21H5.9248C3.51623 21 3 20.4838 3 18.0752V15.9248Z' stroke='#323232' stroke-width='2'/>
                            <path d='M6 13V11.656C6 9.46878 6.46878 9 8.656 9H15.344C17.5312 9 18 9.46878 18 11.656V13' stroke='#323232' stroke-width='2' stroke-linecap='round'/>
                            ...
                            <path d='M3 16.0397C3.30926 16.0122 3.63847 16 4 16C5.61017 16 6.38983 17 8 17C9.61017 17 10.3898 16 12 16C13.6102 16 14.3898 17 16 17C17.6102 17 18.3898 16 20 16C20.3615 16 20.6907 16.0122 21 16.0397' stroke='#323232' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>
                        </svg>
