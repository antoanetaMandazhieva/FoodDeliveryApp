        ...
        <section className='w-full bg-ivory'>
            ...
            <div id='jobs-top' className='aspect-1440/270 bg-ivory w-full relative'>
                ...
                <div className='flex flex-col justify-center items-center pt-2'>
                    <img src={logo} className='max-md:hidden md:h-20 lg:h-36 xl:h-52 max-h-52
            ...
            from-teal to-teal-700 grid grid-rows-1 grid-cols-3 gap-10 pb-2'>
                
                {/* Job 1 */}
                
                <div className='flex flex-col justify-around items-center job'>
                    <div className='h-[50%] w-[70%] flex flex-col justify-center items-center'>
                                <img src={bikerImg} className='max-md:h-[50%] h-[80%] w-auto rounded-full md:pb-8' alt='biker-image'/>
                        <h2 className='max-md:text-lg text-2xl text-ivory font-quicksand font-bold'>Courrier</h2>
                    </div>
                    <p className='md:px-10 max-md:text-sm text-lg text-ivory text-center font-quicksand'>
                ...
                <div className='flex flex-col justify-around items-center job'>
                    <div className='h-[50%] w-[70%] flex flex-col justify-center items-center'>
                        <img src={partnersImg} className='max-md:h-[50%] h-[80%] w-auto rounded-full md:pb-8' alt='biker-image'/>
                        <h2 className='max-md:text-lg text-2xl text-ivory font-quicksand font-bold'>
                            Partner
                        </h2>
                    </div>
                    <p className='md:px-10 max-md:text-sm text-lg text-ivory text-center font-quicksand'>
                ...
                <div className='flex flex-col justify-around items-center job'>
                    <div className='h-[50%] w-[70%] flex flex-col justify-center items-center'>
                        <img src={employeesImg} className='max-md:h-[50%] h-[80%] w-auto rounded-full md:pb-8' alt='biker-image'/>
                        <h2 className='max-md:text-lg text-2xl text-ivory font-quicksand font-bold'>
                            Employee
                        </h2>
                    </div>
